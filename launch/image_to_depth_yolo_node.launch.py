...
def generate_launch_description():
    ...
    inference_server_arg = DeclareLaunchArgument(
        'inference_server',
        default_value='http://localhost:5002/detect',
        description='YOLO object detection server URL')

    detections_topic_arg = DeclareLaunchArgument(
        'detections_topic',
        default_value='camera_3d/detections',
        description='Topic for 3D YOLO detections')
